--TEST--
phpunit-skelgen --test -- BankAccount _fixture/BankAccount.php BankAccountTest php://stdout
--FILE--
<?php
$_SERVER['argv'][1] = '--test';
$_SERVER['argv'][2] = '--';
$_SERVER['argv'][3] = 'BankAccount';
$_SERVER['argv'][4] = dirname(__FILE__) . DIRECTORY_SEPARATOR . '_fixture' . DIRECTORY_SEPARATOR . 'BankAccount.php';
